...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnx2->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn1div
			// 
			...
			this->btn1div->Click += gcnew System::EventHandler(this, &MyForm2::btn1div_Click);
			// 
			// btnSqrt
			// 
			...
			this->btnSqrt->Click += gcnew System::EventHandler(this, &MyForm2::btnSqrt_Click);
			// 
			// btnPM
			// 
			...
			this->btnPM->Click += gcnew System::EventHandler(this, &MyForm2::btnPM_Click);
			// 
			// btnBackSpace
			// 
			...
			this->btnBackSpace->Click += gcnew System::EventHandler(this, &MyForm2::btnBackSpace_Click);
			// 
			// btnC
			// 
			...
			this->btnC->Click += gcnew System::EventHandler(this, &MyForm2::btnC_Click);
			// 
			// btnCE
			// 
			...
			this->btnCE->Click += gcnew System::EventHandler(this, &MyForm2::btnCE_Click_1);
			// 
			// lblShowOp
			// 
			...
			this->btndiv->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btnequal
			// 
			...
			this->btnequal->Click += gcnew System::EventHandler(this, &MyForm2::btnequal_Click);
			// 
			// btnpoint
			// 
			...
			this->btnpoint->Click += gcnew System::EventHandler(this, &MyForm2::btnpoint_Click);
			// 
			// btn0
			// 
			...
			this->btn0->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button9
			// 
			...
			this->btn1->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn2
			// 
			...
			this->btn2->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn3
			// 
			...
			this->btn3->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn6
			// 
			...
			this->btn6->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn5
			// 
			...
			this->btn5->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn4
			// 
			...
			this->btn4->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn9
			// 
			...
			this->btn9->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn8
			// 
			...
			this->btn8->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// btn7
			// 
			...
			this->btn7->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// textDisplay
			// 
			...
			this->menuStrip1->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm2::menuStrip1_MouseDown);
			this->menuStrip1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm2::menuStrip1_MouseMove);
			this->menuStrip1->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm2::menuStrip1_MouseUp);
			// 
			...
			this->standartToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm2::standartToolStripMenuItem_Click);
			// 
			...
			this->engineerToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm2::engineerToolStripMenuItem_Click);
			// 
			...
			this->grathicsToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm2::grathicsToolStripMenuItem_Click);
			// 
			// toolStripMenuItem3
			// 
			...
			this->treeViewSIN->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm2::treeViewSIN_AfterSelect);
			// 
			// btnsin
			// 
			...
			this->btnsin->Click += gcnew System::EventHandler(this, &MyForm2::btnsin_Click);
			// 
			// btncos
			// 
			...
			this->btncos->Click += gcnew System::EventHandler(this, &MyForm2::btncos_Click);
			// 
			// treeViewCOS
			// 
			...
			this->treeViewCOS->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm2::treeViewCOS_AfterSelect);
			// 
			// treeViewCOT
			// 
			...
			this->treeViewCOT->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm2::treeViewCOT_AfterSelect);
			// 
			// btncot
			// 
			...
			this->btncot->Click += gcnew System::EventHandler(this, &MyForm2::btncot_Click);
			// 
			// treeViewTAN
			// 
			...
			this->treeViewTAN->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm2::treeViewTAN_AfterSelect);
			// 
			// btntan
			// 
			...
			this->btntan->Click += gcnew System::EventHandler(this, &MyForm2::btntan_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button4
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &MyForm2::btnx2_Click);
			// 
			// button11
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &MyForm2::button12_Click_1);
			// 
			// textBoxFrom
			// 
			this->textBoxFrom->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->textBoxFrom->Location = System::Drawing::Point(326, 87);
			this->textBoxFrom->Multiline = true;
			this->textBoxFrom->Name = L"textBoxFrom";
			this->textBoxFrom->RightToLeft = System::Windows::Forms::RightToLeft::No;
			this->textBoxFrom->Size = System::Drawing::Size(63, 22);
			this->textBoxFrom->TabIndex = 84;
			this->textBoxFrom->Text = L"10";
			this->textBoxFrom->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// textBoxTo
			// 
			this->textBoxTo->Location = System::Drawing::Point(414, 87);
			this->textBoxTo->Multiline = true;
			this->textBoxTo->Name = L"textBoxTo";
			this->textBoxTo->Size = System::Drawing::Size(63, 22);
			this->textBoxTo->TabIndex = 85;
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(322, 41);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(155, 24);
			this->label1->TabIndex = 86;
			this->label1->Text = L"Numder system";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(329, 70);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label4->Location = System::Drawing::Point(417, 70);
			...
			this->Leave += gcnew System::EventHandler(this, &MyForm2::MyForm1_Closed);
			this->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm2::MyForm2_MouseClick);
...
#pragma endregion
	...
	private: System::Void btnequal_Click(System::Object^ sender, System::EventArgs^ e) {
		int i = Double::Parse(textBoxFrom->Text);
		int j = Double::Parse(textBoxTo->Text);
	string str;
	//Преобразование в систему i
		Convert_String_to_string(textDisplay->Text, str);
		str = ConvertFATA(str, i, 10);
			lblShowOp->Text = Convert_string_to_String(str, lblShowOp->Text);
			//Вывод в десятичной системе для представления
			textDisplay->Text = lblShowOp->Text->Replace(',', '.');

			Convert_String_to_string(textDisplay->Text, str);
			textDisplay->Text = System::Convert::ToString(CALC(str));

//Преобразование в систему j
			str = "";
			Convert_String_to_string(textDisplay->Text, str);
			str = ConvertFATA(str, 10, j);
			textDisplay->Text = Convert_string_to_String(str, textDisplay->Text);
	...
	private: System::Void MyForm2_MouseClick(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
...
private: System::Void engineerToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	Application::OpenForms[L"MyForm"]->Left = this->Left;
	Application::OpenForms[L"MyForm"]->Top = this->Top;
	Application::OpenForms[L"MyForm"]->Text = L"a";
	this->Close();
}
	private: System::Void grathicsToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		Application::OpenForms[L"MyForm"]->Left = this->Left;
		Application::OpenForms[L"MyForm"]->Top = this->Top;
		Application::OpenForms[L"MyForm"]->Text = L"b";
		this->Close();
	}
...
private: System::Void btnCE_Click_1(System::Object^ sender, System::EventArgs^ e) {
	textDisplay->Text = "";
}
...
private: System::Void MyForm2_MouseDown(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	dragging = true;
	diffPos = Point(MousePosition.X - Location.X, MousePosition.Y - Location.Y);
}

private: System::Void MyForm2_MouseUp(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	dragging = false;
}
private: System::Void MyForm2_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	if (dragging == true)
	{
