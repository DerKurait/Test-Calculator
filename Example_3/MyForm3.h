...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnx2->Click += gcnew System::EventHandler(this, &MyForm3::btnx2_Click);
			// 
			// btn1div
			// 
			...
			this->btn1div->Click += gcnew System::EventHandler(this, &MyForm3::btn1div_Click);
			// 
			// btnSqrt
			// 
			...
			this->btnSqrt->Click += gcnew System::EventHandler(this, &MyForm3::btnSqrt_Click);
			// 
			// btnPM
			// 
			...
			this->btnPM->Click += gcnew System::EventHandler(this, &MyForm3::btnPM_Click);
			// 
			// btnBackSpace
			// 
			...
			this->btnBackSpace->Click += gcnew System::EventHandler(this, &MyForm3::btnBackSpace_Click);
			// 
			// btnC
			// 
			...
			this->btnC->Click += gcnew System::EventHandler(this, &MyForm3::btnC_Click_1);
			// 
			// btnCE
			// 
			...
			this->btnCE->Click += gcnew System::EventHandler(this, &MyForm3::btnCE_Click);
			// 
			// lblShowOp
			// 
			...
			this->btndiv->Click += gcnew System::EventHandler(this, &MyForm3::btndiv_Click);
			// 
			// btnequal
			// 
			...
			this->btnequal->Text = L"f(x)=";
			this->btnequal->UseVisualStyleBackColor = true;
			this->btnequal->Click += gcnew System::EventHandler(this, &MyForm3::btnequal_Click);
			// 
			// btnpoint
			// 
			...
			this->btnpoint->Click += gcnew System::EventHandler(this, &MyForm3::btnpoint_Click);
			// 
			// btn0
			// 
			...
			this->btn0->Click += gcnew System::EventHandler(this, &MyForm3::btn0_Click);
			// 
			// button9
			// 
			...
			this->btn1->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn2
			// 
			...
			this->btn2->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn3
			// 
			...
			this->btn3->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn6
			// 
			...
			this->btn6->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn5
			// 
			...
			this->btn5->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn4
			// 
			...
			this->btn4->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn9
			// 
			...
			this->btn9->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn8
			// 
			...
			this->btn8->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// btn7
			// 
			...
			this->btn7->Click += gcnew System::EventHandler(this, &MyForm3::button9_Click);
			// 
			// textDisplay
			// 
			...
			this->menuStrip1->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm3::menuStrip1_MouseDown);
			this->menuStrip1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm3::menuStrip1_MouseMove);
			this->menuStrip1->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm3::menuStrip1_MouseUp);
			// 
			...
			this->standartToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm3::standartToolStripMenuItem_Click);
			// 
			...
			this->engineerToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm3::engineerToolStripMenuItem_Click);
			// 
			...
			this->programmerToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm3::programmerToolStripMenuItem_Click);
			// 
			...
			this->treeViewSIN->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm3::treeViewSIN_AfterSelect);
			// 
			// btnsin
			// 
			...
			this->btnsin->Click += gcnew System::EventHandler(this, &MyForm3::btnsin_Click);
			// 
			// btncos
			// 
			...
			this->btncos->Click += gcnew System::EventHandler(this, &MyForm3::btncos_Click);
			// 
			// treeViewCOS
			// 
			...
			this->treeViewCOS->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm3::treeViewCOS_AfterSelect);
			// 
			// treeViewCOT
			// 
			...
			this->treeViewCOT->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm3::treeViewCOT_AfterSelect);
			// 
			// btncot
			// 
			...
			this->btncot->Click += gcnew System::EventHandler(this, &MyForm3::btncot_Click);
			// 
			// treeViewTAN
			// 
			...
			this->treeViewTAN->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &MyForm3::treeViewTAN_AfterSelect);
			// 
			// btntan
			// 
			...
			this->btntan->Click += gcnew System::EventHandler(this, &MyForm3::btntan_Click);
			// 
			// button1
			// 
			...
			this->button10->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button10->Location = System::Drawing::Point(12, 164);
			...
			this->button12->Click += gcnew System::EventHandler(this, &MyForm3::button12_Click_1);
			// 
			// button14
			// 
			this->button14->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button14->Location = System::Drawing::Point(512, 569);
			...
			this->button15->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button15->Location = System::Drawing::Point(342, 283);
			...
			this->Leave += gcnew System::EventHandler(this, &MyForm3::MyForm3_Closed);
			this->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm3::MyForm3_MouseClick);
...
#pragma endregion
	...
	private: System::Void btnequal_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//string str = "2";
		//mod(0.25*(x)+3*(cosr((x)*100)*sinr((x))))
		//mod(0.25*(x)+3*(cosr((x)*10)))
	...
	private: System::Void MyForm3_MouseClick(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
	...
	private: System::Void MyForm3_Closed(System::Object^ sender, System::EventArgs^ e) {
